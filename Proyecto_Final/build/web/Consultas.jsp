      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            ...
            <div class="body">
              <h5>Consulta de Inscripcion</h5>
              <a href="ConsultaRegistro.jsp" class="btn btn-primary">Consultar Inscripcion</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            ...
            <div class="body">
              <h5>Constancia de Vacunacion </h5>
              <a href="ConstanciaVacunacion.jsp" class="btn btn-primary">Constancia</a>
            </div>
          </div>
        </div>
      <div class="col-lg-2">
