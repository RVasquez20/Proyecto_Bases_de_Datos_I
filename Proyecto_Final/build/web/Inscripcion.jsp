...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<h3 class="text-center">
				Inscripcion para Vacunacion contra Covid-19
			</h3>
                    <br>
	...
	<div class="row">
		...
		<div class="col-md-2">
                    <br><br>
                    <form action="sr_Inscripcion" method="post" class="form-inline text-center">
    ...
    <input type="text" name="txt_DPI" id="txt_DPI" class="form-control mb-2 mr-sm-2" maxlength="13" onkeypress="return entero(event);" required required><br>
               ...
               <button name="btn_agregarInscripcion" id="btn_agregarInscripcion" value="agregarInscripcion" class="btn btn-success" >Inscribir</button>
               </div>
