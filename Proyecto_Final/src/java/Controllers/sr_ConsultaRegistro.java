 ...
 * @author rodri
 */
@WebServlet(name = "sr_ConsultaRegistro", urlPatterns = {"/sr_ConsultaRegistro"})
public class sr_ConsultaRegistro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          if ("ConsultarInscripcion".equals(request.getParameter("btn_ConsultarI"))) {
           ...
           try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<script type=\"text/javascript\">");
                ...
                out.println("<h4>"+mensajes+"</h4>");              
                    ...
                    out.println("<button type='button' onclick=\"location.href='ConsultaRegistro.jsp'\" class='btn btn-danger' data-dismiss='modal'>Cerrar</button>");
