...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<h3 class="text-center">
				Registro de Aplicacion de Primera Dosis
			</h3>
                    <br>
	...
	<div class="row">
		...
		<div class="col-md-2">
                    <br><br>
                    <form action="sr_PrimeraDosis" method="post" class="form-inline text-center">
    ...
    <input type="text" name="txt_DPI" id="txt_DPI" class="form-control mb-2 mr-sm-2" maxlength="13" onkeypress="return entero(event);" required required><br>
               ...
               <button name="btn_agregarPrimeraDosis" id="btn_agregarPrimeraDosis" value="agregarPrimeraDosis" class="btn btn-success" >Registrar</button>
               </div>
