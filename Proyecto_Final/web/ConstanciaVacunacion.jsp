...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-4">
                    <br><br>
                    <form action="sr_Aplicaciones" method="post" class="form-inline">
    ...
    <input type="text" name="txt_DPI" id="txt_DPI" class="form-control mb-2 mr-sm-2" maxlength="13" onkeypress="return entero(event);" required required><br>
               ...
               <button name="btn_Constancia" id="btn_Constancia" value="Constancia" class="btn btn-success" >Constancia</button>
               </div>
