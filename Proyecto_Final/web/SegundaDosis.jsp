...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<h3 class="text-center">
				Registro de Aplicacion de Segunda Dosis
			</h3>
                    <br>
	...
	<div class="row">
		...
		<div class="col-md-2">
                    <br><br>
                    <form action="sr_SegundaDosis" method="post" class="form-inline text-center">
                       
    <label for="DPI" class="mr-sm-2">DPI:</label>
    <input type="text" name="txt_DPI" id="txt_DPI" class="form-control mb-2 mr-sm-2" maxlength="13" onkeypress="return entero(event);" required required><br>
                <br>
               <br><br>
               <div class="container-fluid" style="text-align: center;">
               <button name="btn_agregarSegundaDosis" id="btn_agregarSegundaDosis" value="agregarSegundaDosis" class="btn btn-success" >Agregar Segunda Dosis</button>
               </div>
